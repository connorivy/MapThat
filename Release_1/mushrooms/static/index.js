        ...
        control = L.Control.fileLayerLoad({
            ...
            layerOptions: {
                pointToLayer: function (data, latlng) {
                    ...
                    var href = '<p><button class="btn btn-warning" style="width:10rem;display: block; margin: 0 auto;"><a class="text-dark" style="text-decoration:none;" href="/email/' + path + '">Send Image</a></button></p>'
